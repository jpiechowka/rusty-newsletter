...
impl TestApp {
    ...
    {
        self.api_client
            .post(&format!("{}/login", &self.serve_address))
            .form(body)
            .send()
            .await
    ...
    pub async fn get_login_html(&self) -> String {
        self.api_client
            .get(&format!("{}/login", &self.serve_address))
            .send()
            .await
            .expect("Failed to execute request")
            .text()
    ...
    pub async fn get_admin_dashboard(&self) -> reqwest::Response {
        self.api_client
            .get(&format!("{}/admin/dashboard", &self.serve_address))
            .send()
            .await
            .expect("Failed to execute request")
    }
    ...
    pub async fn get_change_password(&self) -> reqwest::Response {
        self.api_client
            .get(&format!("{}/admin/password", &self.serve_address))
            .send()
            .await
            .expect("Failed to execute request")
    }
    ...
    pub async fn post_logout(&self) -> reqwest::Response {
        self.api_client
            .post(&format!("{}/admin/logout", &self.serve_address))
            .send()
            .await
            .expect("Failed to execute request")
    }
    ...
    {
        self.api_client
            .post(&format!("{}/admin/password", &self.serve_address))
            .form(body)
            .send()
            .await
            .expect("Failed to execute request")
    ...
    pub async fn get_publish_newsletter(&self) -> reqwest::Response {
        self.api_client
            .get(&format!("{}/admin/newsletters", &self.serve_address))
            .send()
            .await
            .expect("Failed to execute request")
    }
    ...
    {
        self.api_client
            .post(&format!("{}/admin/newsletters", &self.serve_address))
            .form(body)
            .send()
            .await
            .expect("Failed to execute request")
    ...
    pub async fn dispatch_all_pending_emails(&self) {
        loop {
            if let ExecutionOutcome::EmptyQueue =
                try_execute_task(&self.db_conn_pool, &self.email_client)
                    .await
                    .unwrap()
            {
                break;
...
pub async fn spawn_app() -> TestApp {
    ...
    let test_app = TestApp {
        serve_address: format!("http://localhost:{}", application_port),
    ...
    test_app.test_user.store(&test_app.db_conn_pool).await;
