...
#[tracing::instrument(
    ...
    skip(form, db_conn_pool, email_client, base_url),
    fields(
...
pub async fn subscribe(
    ...
    let subscriber_id = match insert_subscriber(&db_conn_pool, &new_subscriber).await {
    ...
    if store_token(&db_conn_pool, subscriber_id, &subscription_token)
        .await
        .is_err()
    {
